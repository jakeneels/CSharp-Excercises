...
--select name, population from city where countrycode = 'usa' and population > 1000000 -- name, population where name = '' and population > 1
...
select name, (2018 - indepyear) as years_since_independence from country where indepyear is not null  order by years_since_independence desc